  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center h-[calc(100vh-12rem)]"> {/* Adjust height as needed */}
        <h1 className="text-5xl font-bold text-off-white mb-4">Welcome to My Portfolio!</h1>
        <p className="text-xl text-off-white">Your professional journey starts here.</p>
